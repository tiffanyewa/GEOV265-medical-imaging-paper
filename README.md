...
## Key Topics
- Limitations of CT, MRI, and ultrasound in high acoustic-impedance contrast regions (skull, bone)
- FWI combined with Adaptive Waveform Inversion (AWI) for transcranial brain imaging
- 3D inverse scattering (QTUS) for musculoskeletal imaging without artefacts
- Computational feasibility: FWI (~30 hrs) vs. inverse scattering (~24 min)

## File
- `Reconstructing_the_Invisible.pdf` — full paper (3015 words)
